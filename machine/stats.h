...
class Statistics {
  public:
    ...
    int numTLBHit;			// number of TLB hit
    int numTLBMiss;			// number of TLB miss and throw PageFaultException
...
#define TimerTicks 	50//100    	// (average) time between timer interrupts
